...
project = 'omnipath_metabo'
version = omnipath_metabo.__version__
author = ', '.join(omnipath_metabo.__author__)
years = '-'.join(sorted({'2022', f'{datetime.now():%Y}'}))
copyright = f'{years}, Saez Lab'
repository_url = 'https://github.com/saezlab/omnipath-metabo'
